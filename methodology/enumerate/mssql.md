...
```bash
#all scripts
nmap -vv -sV -Pn -p [port] --script=ms-sql-info,ms-sql-config,ms-sql-dump-hashes --script-args=mssql.instance-port=1433,smsql.username-sa,mssql.password-sa [ip]
